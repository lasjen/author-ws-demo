package no.rightcloud.demo.author.service;

import no.rightcloud.demo.author.dao.AuthorDAO;
import no.rightcloud.demo.author.dao.DAOFactory;
...
public class AuthorService {
   ...
   public boolean truncAuthor() { return dao.truncate();}
}
